...
//                   // Gunakan AssetImage untuk memuat dari folder assets
//                   backgroundImage: AssetImage('assets/images/profil.jpg'),
//                 ),
//                 const SizedBox(height: 20), // Jarak antara gambar dan nama
...
//                 ),
//                 const SizedBox(height: 20), // Jarak antara nama dan detail

//                 // --- Card untuk Info Detail ---
//                 Card(
...
//                         _buildProfileInfoRow(
//                           context,
//                           icon: Icons.lightbulb_outline, // Icon untuk saran
//                           title: 'Saran',
//                           value:
//                               'deadline tugas akhir jangan terlalu singkat pak',
//                         ),
//                         const Divider(height: 20),
//                         _buildProfileInfoRow(
//                           context,
//                           icon: Icons.thumb_up_alt_outlined, // Icon untuk kesan
//                           title: 'Kesan Pesan',
//                           value: 'Matkul Keren',
//                         ),
//                       ],
...
//                 const SizedBox(height: 40), // Jarak ke tombol logout
...
//                     minimumSize:
//                         const Size(double.infinity, 50), // Buat tombol lebar
//                     shape: RoundedRectangleBorder(
//                       borderRadius: BorderRadius.circular(12.0),
//                     ),
//                   ),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Info Card with book-style design
                  Container(
                    width: double.infinity,
                    decoration: BoxDecoration(
                      color: _parchment,
                  ...
                  Container(
                    padding: const EdgeInsets.all(16),
                    decoration: BoxDecoration(
                      color: _brownSaddle.withOpacity(0.05),
                      borderRadius: BorderRadius.circular(12),
                      border: Border.all(
                        color: _gold.withOpacity(0.3),
                        width: 1,
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.format_quote, color: _gold, size: 24),
                        const SizedBox(width: 12),
                        Expanded(
                          child: Text(
