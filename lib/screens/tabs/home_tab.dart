...
//     return Scaffold(
//       appBar: AppBar(
//         title: const Text('Perpustakaan Novel'),
//         actions: [
//           IconButton(
...
//         ],
//       ),
//       // 2. Bungkus body dengan Consumer ganda (atau pakai Consumer<FavoriteProvider>)
//       // Kita akan pakai Consumer<BookProvider> di luar
//       // dan Consumer<FavoriteProvider> di dalam list
...
//             return const Center(
//                 child: Text('Gagal memuat buku. Coba lagi nanti.'));
//           }
...
//                   // 3. Ubah Trailing menjadi tombol Like
...
//                   // 4. onTap untuk navigasi tetap sama
//                   onTap: () {
//                     Navigator.push(
//                       context,
//                       MaterialPageRoute(
