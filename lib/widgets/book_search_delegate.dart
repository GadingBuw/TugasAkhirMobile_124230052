...
//       onPressed: () {
//         close(context, null); // Kembali ke halaman sebelumnya
//       },
//     );
//   }
...
//     // Panggil provider untuk melakukan pencarian saat user menekan 'enter'
//     final bookProvider = Provider.of<BookProvider>(context, listen: false);
    
//     // Hanya panggil jika query berbeda dari state sebelumnya atau state masih initial
//     if (query.isNotEmpty) {
...
//     // Bisa juga panggil searchBooks(query) di sini untuk live search
//     // Tapi untuk API, lebih baik di buildResults agar tidak terlalu banyak request
//     // Kita tampilkan 'Start typing...'
//     if (query.isEmpty) {
//       return const Center(child: Text('Ketik untuk mencari buku...'));
//     }
    
//     // Atau, kita bisa buat live-search
//     // Panggil searchBooks di sini jika ingin saran muncul saat mengetik
//     // Provider.of<BookProvider>(context, listen: false).searchBooks(query);
//     // return _buildSearchResults();
    
//     // Untuk saat ini, kita akan tampilkan loading dan menunggu user menekan search
//     return const Center(
//       child: Text('Tekan tombol search di keyboard untuk mencari.'),
//     );
//   }
...
//           return Center(child: Text('Buku "$query" tidak ditemukan.'));
//         }
...
//                 subtitle: Text(book.firstAuthorName),
//                 onTap: () {
//                   // Tutup search dan buka halaman detail
//                   close(context, null);
//                   Navigator.push(
//                     context,
//                     MaterialPageRoute(
